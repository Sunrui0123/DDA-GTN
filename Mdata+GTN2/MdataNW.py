...
#         #                            num_class=3,
#         #                            args=args)
#         self.encoder = GCN(node_features.shape[1], 128, 256)
#
#         self.w = nn.Sequential(
#             # nn.BatchNorm1d(512),
#             nn.Linear(512, 128),
...
#
#     def encode(self):
#         # x = self.encoder(A, node_features, num_nodes=num_nodes)
#         x = self.encoder(node_features, A)
#         return x
#
#     def decode(self, z, edge_label_index):
...
if __name__ == '__main__':
    ...
    if args.crossValidation == 1:
        ...
        result_file.write(f'单向边--没有权重-五折--GPU--seed--222\n')
